...
const OPCIONES_CIFRAS = [
  ...
  { label: 'Visitas virtuales', value: 'visitasVirtuales' },
  { label: 'Horas de visita', value: 'horasDeVisita' },
...
export default config({
  ...
  singletons: {
	...
	visitasVirtuales: fields.integer({ label: 'Visitas virtuales' }),
	horasDeVisita: fields.integer({ label: 'Horas de visita' }),
